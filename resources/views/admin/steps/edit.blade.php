    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.steps.update", [$step->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sender') ? 'is-invalid' : '' }}" type="email" name="sender" id="sender" value="{{ old('sender', $step->sender) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('template_client') ? 'is-invalid' : '' }}" name="template_client" id="template_client">{!! old('template_client', $step->template_client) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('template_company') ? 'is-invalid' : '' }}" name="template_company" id="template_company">{!! old('template_company', $step->template_company) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('template_user') ? 'is-invalid' : '' }}" name="template_user" id="template_user">{!! old('template_user', $step->template_user) !!}</textarea>
