    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.funnels.update", [$funnel->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_2') ? 'is-invalid' : '' }}" name="description_2" id="description_2">{!! old('description_2', $funnel->description_2) !!}</textarea>
