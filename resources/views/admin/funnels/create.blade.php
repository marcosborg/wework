    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.funnels.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_text') ? 'is-invalid' : '' }}" type="text" name="file_text" id="file_text" value="{{ old('file_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('message_text') ? 'is-invalid' : '' }}" type="text" name="message_text" id="message_text" value="{{ old('message_text', '') }}">
