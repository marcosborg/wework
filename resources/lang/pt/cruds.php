...
return [
    ...
    'step' => [
        ...
        'fields'         => [
            ...
            'template_client_helper'  => '{ user } { client } { company } { funil } { passo } { criado_em } { atualizado_em }',
            'template_company'        => 'Template Company',
            'template_company_helper' => '{ user } { client } { company } { funil } { passo } { criado_em } { atualizado_em }',
            'template_user'           => 'Template User',
            'template_user_helper'    => '{ user } { client } { company } { funil } { passo } { criado_em } { atualizado_em }',
        ],
    ],
    'category' => [
        'title'          => 'Categorias',
